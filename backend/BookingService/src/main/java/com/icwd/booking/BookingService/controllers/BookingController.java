...
public class BookingController {
    ...
    public ResponseEntity<BookingEntity> createBooking(
        ...
        log.info(
                "Received request to create booking. userId={}, roomId={}"

        );
        BookingEntity booking =
                bookingService.createBooking(bookingEntity);
        log.info(
                "Booking created successfully. bookingId={}, userId={}, roomId={}"
    ...
    public ResponseEntity<BookingEntity> getBooking(
        ...
        log.debug("Booking retrieved successfully. bookingId={}", bookingId);
        return ResponseEntity.ok(
